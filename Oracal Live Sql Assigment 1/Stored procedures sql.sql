...
CREATE OR REPLACE PROCEDURE REDQNT(QUNT IN NUMBER)  
AS  
BEGIN  
UPDATE ORDERS SET QUANTITY=QUANTITY-1 WHERE ORDERID=QUNT;  
END; 
...
create or replace procedure bajaj(oid in int)  
as  
begin  
update orders set totalamount=round(totalamount-(totalamount*9/100))where orderid=oid;  
end;
/
